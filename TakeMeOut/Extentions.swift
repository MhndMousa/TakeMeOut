...
struct Colors {
    ...
    static let darkPink         = UIColor(hex: "EC407A")!
    static let darkOrange       = UIColor(hex: "FFA726")!
    static let teal             = UIColor(hex: "4DB6AC")!
    static let limeGreen        = UIColor(hex: "AED581")!
}
